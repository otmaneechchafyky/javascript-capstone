...
(0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__["default"])(Comments, "url", 'https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/Wi60sKUpCmISIO1yYIJP/comments');
...
(0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__["default"])(GetPoke, "getCount", function () {
  ...
  counters.textContent = "Pokemons (".concat(count, ")");
...
(0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__["default"])(GetPoke, "createModal", function () {
  ...
  var openModal = function openModal(e) {
    ...
    if (parentElement.id === e.target.id) {
      ...
      var secondChild = parentElement.firstElementChild.nextElementSibling;
      var formId = firstChild.nextElementSibling.firstElementChild.innerHTML;
      var popUpId = firstChild.firstElementChild.alt;
      form.setAttribute('id', formId);
      popUp.setAttribute('id', popUpId);
      popTop.innerHTML = "\n          <img class=\"top-img\" src=\"".concat(firstChild.firstElementChild.src, "\">\n        ");
      popTitle.innerHTML = "".concat(secondChild.firstElementChild.innerHTML);
      desc1.innerHTML = "Power: ".concat(e.target.previousElementSibling.id);
      desc2.innerHTML = "Collected: ".concat(secondChild.children[1].id);
    }
  };
  ...
  var closeButtons = document.querySelectorAll('.close-pop');
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.prev = 2;
              _context2.next = 5;
              return _comments_js__WEBPACK_IMPORTED_MODULE_7__["default"].postComment(e.target.id, inputName.value, inputTextarea.value);

            case 5:
              d = _context2.sent;

              if (d === 'Created') {
                commentsDiv = document.querySelector('.comments-list');
...
(0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__["default"])(Likes, "likeUrl", 'https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/sSOo1SGKw5gz6ax9ywvh/likes');
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n  font-family: \"Oswald\", sans-serif;\n}\n\nul {\n  list-style: none;\n}\n\na {\n  text-decoration: none;\n}\n\nbody {\n  background: #6f23ff;\n}\n\nheader {\n  margin: auto;\n  padding: 2% 11%;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  background-color: #fff;\n}\n\n#poke-logo {\n  color: #6f23ff;\n  padding: 7px 10px;\n  border: 2px solid #6f23ff;\n  border-radius: 10px;\n}\n\n.nav-items {\n  display: flex;\n  gap: 4rem;\n  width: auto;\n}\n\n.nav-item a {\n  color: #6f23ff;\n  font-size: 1.5rem;\n  font-weight: 500;\n}\n\nfooter {\n  position: fixed;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  padding: 1% 10%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background: #fff;\n}\n\n.f-para {\n  font-size: 1.5rem;\n  font-weight: 400;\n  color: #6f23ff;\n}\n\n.pokemons {\n  display: grid;\n  grid-template-columns: 1fr 1fr 1fr 1fr;\n  padding: 2% 10%;\n  margin-bottom: 40px;\n}\n\n.poke-card {\n  background-color: #eee;\n  border-radius: 20px;\n  box-shadow: 0 3px 15px rgba(100, 100, 100, 0.5);\n  margin: 10px;\n  padding: 20px;\n  text-align: center;\n  transition: 0.3s ease;\n}\n\n.poke-card:hover {\n  transform: scale(1.1);\n}\n\n.poke-img {\n  background-color: rgba(255, 255, 255, 0.6);\n  border-radius: 50%;\n  width: 120px;\n  height: 120px;\n  text-align: center;\n  margin: auto;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  border: 2px solid #6f23ff;\n}\n\n.poke-img img {\n  margin-top: 10px;\n  max-width: 50%;\n}\n\n.poke-content {\n  margin: 1.25rem 0;\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n}\n\n.poke-name {\n  font-size: 1.3rem;\n  font-weight: 400;\n  text-transform: capitalize;\n  display: flex;\n  align-self: self-start;\n}\n\n.poke-likes {\n  display: flex;\n  gap: 10px;\n  font-size: 1.1rem;\n  justify-content: right;\n  align-items: center;\n}\n\n.poke-likes i {\n  color: red;\n  transition: 0.2s ease-in-out;\n}\n\n.poke-likes i:hover {\n  cursor: pointer;\n  transform: scale(1.5);\n}\n\n.comment-button {\n  padding: 0.5rem;\n  width: 100%;\n  border: 2px solid transparent;\n  border-radius: 10px;\n  font-size: 18px;\n  font-weight: 400;\n  transition: 0.2s ease-in-out;\n  border-color: #6f23ff;\n  background-color: transparent;\n  color: #6f23ff;\n}\n\n.comment-button:hover {\n  cursor: pointer;\n  background: #6f23ff;\n  color: #fff;\n}\n\n/* .comments-list {\n  display: flex;\n  flex-direction: column;\n} */\n.pop-up {\n  position: fixed;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%) scale(0);\n  transition: 0.2s ease-in-out;\n  padding: 2%;\n  border-radius: 20px;\n  z-index: 20;\n  width: 60%;\n  max-width: 80%;\n  background: #6f23ff;\n  color: #fff;\n  max-height: 97%;\n  overflow-y: scroll;\n}\n\n#shadow {\n  position: fixed;\n  z-index: 3;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  background-color: rgba(0, 0, 0, 0.8);\n  transition: 0.2s ease-in-out;\n  pointer-events: none;\n  opacity: 0;\n}\n\n#shadow.active {\n  opacity: 1;\n  pointer-events: all;\n}\n\n.pop-up.active {\n  transform: translate(-50%, -50%) scale(1);\n}\n\n.pop-top {\n  max-width: 10rem;\n  max-height: 10rem;\n  padding: 2rem;\n  background-color: #fff;\n  border-radius: 50%;\n  margin: auto;\n  text-align: center;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n\n.pop-top img {\n  max-width: 100%;\n}\n\n.close-pop {\n  position: absolute;\n  top: 20px;\n  right: 20px;\n  text-align: center;\n  font-size: 35px;\n  font-weight: 400;\n  color: white;\n  padding: 0 10px;\n  width: 3.5rem;\n  background-color: rgba(255, 0, 0, 0.836);\n  border: none;\n  border-radius: 7px;\n  transition: transform 0.2s ease-in-out;\n}\n\n.close-pop:hover {\n  cursor: pointer;\n  transform: scale(0.9);\n  background-color: red;\n}\n\n.pop-title {\n  text-align: center;\n  margin-top: 1rem;\n  font-weight: 400;\n  font-size: 1.5rem;\n  text-transform: capitalize;\n}\n\n.pop-desc {\n  display: flex;\n  justify-content: space-evenly;\n  margin-top: 10px;\n}\n\n.pop-comments {\n  height: 40%;\n}\n\n.display-comments {\n  text-align: center;\n  font-size: 15px;\n  font-weight: 200;\n  margin-top: 10px;\n}\n\n.comments-list {\n  font-size: 15px;\n  display: flex;\n  flex-direction: column;\n  align-items: start;\n  gap: 0.8rem;\n  padding-left: 9.5rem;\n  margin: 2rem 0;\n  width: 82%;\n}\n\n.add-comment {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  gap: 20px;\n}\n\n.form-title {\n  font-size: 15px;\n  font-weight: 200;\n}\n\n.comment-input,\n.comment-textarea {\n  border: none;\n  padding: 5px 10px;\n  border-radius: 10px;\n  width: 60%;\n  height: 3rem;\n}\n\n.comment-textarea {\n  height: 7rem;\n}\n\n.comment-input:focus,\n.comment-textarea:focus {\n  outline: 2px solid rgb(96, 165, 250);\n}\n\n.add-button {\n  padding: 0.5rem;\n  border: 2px solid #fff;\n  color: #fff;\n  border-radius: 10px;\n  font-size: 18px;\n  font-weight: 400;\n  transition: 0.2s ease-in-out;\n  width: 60%;\n  height: 3rem;\n  background-color: transparent;\n}\n\n.add-button:hover {\n  cursor: pointer;\n  color: #6f23ff;\n  background-color: #fff;\n}\n\n@media only screen and (max-width: 768px) {\n  .pop-up {\n    width: 80%;\n    max-width: 100%;\n    height: auto;\n    padding-bottom: 2%;\n  }\n\n  .comments-list {\n    grid-template-columns: 1fr;\n    padding: 1% 3% 1% 10%;\n    line-height: 0;\n  }\n\n  .comments-list li {\n    line-height: 20px;\n  }\n}\n@media only screen and (max-width: 768px) {\n  .pokemons {\n    display: grid;\n    grid-template-columns: 1fr 1fr;\n    padding: 2% 3%;\n    margin-bottom: 80px;\n  }\n}\n@media only screen and (max-width: 370px) {\n  .pokemons {\n    display: grid;\n    grid-template-columns: 1fr;\n    padding: 2% 3%;\n  }\n}\n@media only screen and (min-width: 770px) {\n  .pokemons {\n    display: grid;\n    grid-template-columns: 1fr 1fr 1fr;\n    padding: 2% 3%;\n  }\n}\n@media only screen and (min-width: 1090px) {\n  .pokemons {\n    display: grid;\n    grid-template-columns: 1fr 1fr 1fr;\n    padding: 2% 3%;\n  }\n}\n@media only screen and (min-width: 1235px) {\n  .pokemons {\n    display: grid;\n    grid-template-columns: 1fr 1fr 1fr 1fr;\n    padding: 2% 10%;\n  }\n}\n@media only screen and (max-width: 960px) {\n  .nav-item a {\n    font-size: 20px;\n  }\n\n  #poke-logo {\n    width: 52%;\n    max-width: 55%;\n  }\n}\n@media only screen and (max-width: 768px) {\n  #poke-logo {\n    width: 50%;\n    max-width: 50%;\n  }\n}\n@media only screen and (max-width: 496px) {\n  #poke-logo {\n    width: 80%;\n    max-width: 100%;\n  }\n\n  header {\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n    gap: 20px;\n    padding: 2% 10%;\n  }\n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,SAAA;EACA,UAAA;EACA,sBAAA;EACA,iCAAA;AACF;;AAEA;EACE,gBAAA;AACF;;AAEA;EACE,qBAAA;AACF;;AAEA;EACE,mBAAA;AACF;;AAEA;EACE,YAAA;EACA,eAAA;EACA,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,sBAAA;AACF;;AAEA;EACE,cAAA;EACA,iBAAA;EACA,yBAAA;EACA,mBAAA;AACF;;AAEA;EACE,aAAA;EACA,SAAA;EACA,WAAA;AACF;;AAEA;EACE,cAAA;EACA,iBAAA;EACA,gBAAA;AACF;;AAEA;EACE,eAAA;EACA,SAAA;EACA,OAAA;EACA,QAAA;EACA,eAAA;EACA,aAAA;EACA,mBAAA;EACA,uBAAA;EACA,gBAAA;AACF;;AAEA;EACE,iBAAA;EACA,gBAAA;EACA,cAAA;AACF;;AAEA;EACE,aAAA;EACA,sCAAA;EACA,eAAA;EACA,mBAAA;AACF;;AAEA;EACE,sBAAA;EACA,mBAAA;EACA,+CAAA;EACA,YAAA;EACA,aAAA;EACA,kBAAA;EACA,qBAAA;AACF;;AAEA;EACE,qBAAA;AACF;;AAEA;EACE,0CAAA;EACA,kBAAA;EACA,YAAA;EACA,aAAA;EACA,kBAAA;EACA,YAAA;EACA,aAAA;EACA,mBAAA;EACA,uBAAA;EACA,yBAAA;AACF;;AAEA;EACE,gBAAA;EACA,cAAA;AACF;;AAEA;EACE,iBAAA;EACA,aAAA;EACA,mBAAA;EACA,8BAAA;AACF;;AAEA;EACE,iBAAA;EACA,gBAAA;EACA,0BAAA;EACA,aAAA;EACA,sBAAA;AACF;;AAEA;EACE,aAAA;EACA,SAAA;EACA,iBAAA;EACA,sBAAA;EACA,mBAAA;AACF;;AAEA;EACE,UAAA;EACA,4BAAA;AACF;;AAEA;EACE,eAAA;EACA,qBAAA;AACF;;AAEA;EACE,eAAA;EACA,WAAA;EACA,6BAAA;EACA,mBAAA;EACA,eAAA;EACA,gBAAA;EACA,4BAAA;EACA,qBAAA;EACA,6BAAA;EACA,cAAA;AACF;;AAEA;EACE,eAAA;EACA,mBAAA;EACA,WAAA;AACF;;AAEA;;;GAAA;AAKA;EACE,eAAA;EACA,QAAA;EACA,SAAA;EACA,yCAAA;EACA,4BAAA;EACA,WAAA;EACA,mBAAA;EACA,WAAA;EACA,UAAA;EACA,cAAA;EACA,mBAAA;EACA,WAAA;EACA,eAAA;EACA,kBAAA;AAAF;;AAGA;EACE,eAAA;EACA,UAAA;EACA,MAAA;EACA,QAAA;EACA,SAAA;EACA,OAAA;EACA,oCAAA;EACA,4BAAA;EACA,oBAAA;EACA,UAAA;AAAF;;AAGA;EACE,UAAA;EACA,mBAAA;AAAF;;AAGA;EACE,yCAAA;AAAF;;AAGA;EACE,gBAAA;EACA,iBAAA;EACA,aAAA;EACA,sBAAA;EACA,kBAAA;EACA,YAAA;EACA,kBAAA;EACA,aAAA;EACA,mBAAA;EACA,uBAAA;AAAF;;AAGA;EACE,eAAA;AAAF;;AAGA;EACE,kBAAA;EACA,SAAA;EACA,WAAA;EACA,kBAAA;EACA,eAAA;EACA,gBAAA;EACA,YAAA;EACA,eAAA;EACA,aAAA;EACA,wCAAA;EACA,YAAA;EACA,kBAAA;EACA,sCAAA;AAAF;;AAGA;EACE,eAAA;EACA,qBAAA;EACA,qBAAA;AAAF;;AAGA;EACE,kBAAA;EACA,gBAAA;EACA,gBAAA;EACA,iBAAA;EACA,0BAAA;AAAF;;AAGA;EACE,aAAA;EACA,6BAAA;EACA,gBAAA;AAAF;;AAGA;EACE,WAAA;AAAF;;AAGA;EACE,kBAAA;EACA,eAAA;EACA,gBAAA;EACA,gBAAA;AAAF;;AAGA;EACE,eAAA;EACA,aAAA;EACA,sBAAA;EACA,kBAAA;EACA,WAAA;EACA,oBAAA;EACA,cAAA;EACA,UAAA;AAAF;;AAGA;EACE,aAAA;EACA,sBAAA;EACA,uBAAA;EACA,mBAAA;EACA,SAAA;AAAF;;AAGA;EACE,eAAA;EACA,gBAAA;AAAF;;AAGA;;EAEE,YAAA;EACA,iBAAA;EACA,mBAAA;EACA,UAAA;EACA,YAAA;AAAF;;AAGA;EACE,YAAA;AAAF;;AAGA;;EAEE,oCAAA;AAAF;;AAGA;EACE,eAAA;EACA,sBAAA;EACA,WAAA;EACA,mBAAA;EACA,eAAA;EACA,gBAAA;EACA,4BAAA;EACA,UAAA;EACA,YAAA;EACA,6BAAA;AAAF;;AAGA;EACE,eAAA;EACA,cAAA;EACA,sBAAA;AAAF;;AAGA;EACE;IACE,UAAA;IACA,eAAA;IACA,YAAA;IACA,kBAAA;EAAF;;EAGA;IACE,0BAAA;IACA,qBAAA;IACA,cAAA;EAAF;;EAGA;IACE,iBAAA;EAAF;AACF;AAGA;EACE;IACE,aAAA;IACA,8BAAA;IACA,cAAA;IACA,mBAAA;EADF;AACF;AAIA;EACE;IACE,aAAA;IACA,0BAAA;IACA,cAAA;EAFF;AACF;AAKA;EACE;IACE,aAAA;IACA,kCAAA;IACA,cAAA;EAHF;AACF;AAMA;EACE;IACE,aAAA;IACA,kCAAA;IACA,cAAA;EAJF;AACF;AAOA;EACE;IACE,aAAA;IACA,sCAAA;IACA,eAAA;EALF;AACF;AAQA;EACE;IACE,eAAA;EANF;;EASA;IACE,UAAA;IACA,cAAA;EANF;AACF;AASA;EACE;IACE,UAAA;IACA,cAAA;EAPF;AACF;AAUA;EACE;IACE,UAAA;IACA,eAAA;EARF;;EAWA;IACE,sBAAA;IACA,uBAAA;IACA,mBAAA;IACA,SAAA;IACA,eAAA;EARF;AACF","sourcesContent":["* {\r\n  margin: 0;\r\n  padding: 0;\r\n  box-sizing: border-box;\r\n  font-family: 'Oswald', sans-serif;\r\n}\r\n\r\nul {\r\n  list-style: none;\r\n}\r\n\r\na {\r\n  text-decoration: none;\r\n}\r\n\r\nbody {\r\n  background: #6f23ff;\r\n}\r\n\r\nheader {\r\n  margin: auto;\r\n  padding: 2% 11%;\r\n  display: flex;\r\n  justify-content: space-between;\r\n  align-items: center;\r\n  background-color: #fff;\r\n}\r\n\r\n#poke-logo {\r\n  color: #6f23ff;\r\n  padding: 7px 10px;\r\n  border: 2px solid #6f23ff;\r\n  border-radius: 10px;\r\n}\r\n\r\n.nav-items {\r\n  display: flex;\r\n  gap: 4rem;\r\n  width: auto;\r\n}\r\n\r\n.nav-item a {\r\n  color: #6f23ff;\r\n  font-size: 1.5rem;\r\n  font-weight: 500;\r\n}\r\n\r\nfooter {\r\n  position: fixed;\r\n  bottom: 0;\r\n  left: 0;\r\n  right: 0;\r\n  padding: 1% 10%;\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: center;\r\n  background: #fff;\r\n}\r\n\r\n.f-para {\r\n  font-size: 1.5rem;\r\n  font-weight: 400;\r\n  color: #6f23ff;\r\n}\r\n\r\n.pokemons {\r\n  display: grid;\r\n  grid-template-columns: 1fr 1fr 1fr 1fr;\r\n  padding: 2% 10%;\r\n  margin-bottom: 40px;\r\n}\r\n\r\n.poke-card {\r\n  background-color: #eee;\r\n  border-radius: 20px;\r\n  box-shadow: 0 3px 15px rgba(100, 100, 100, 0.5);\r\n  margin: 10px;\r\n  padding: 20px;\r\n  text-align: center;\r\n  transition: 0.3s ease;\r\n}\r\n\r\n.poke-card:hover {\r\n  transform: scale(1.1);\r\n}\r\n\r\n.poke-img {\r\n  background-color: rgba(255, 255, 255, 0.6);\r\n  border-radius: 50%;\r\n  width: 120px;\r\n  height: 120px;\r\n  text-align: center;\r\n  margin: auto;\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: center;\r\n  border: 2px solid #6f23ff;\r\n}\r\n\r\n.poke-img img {\r\n  margin-top: 10px;\r\n  max-width: 50%;\r\n}\r\n\r\n.poke-content {\r\n  margin: 1.25rem 0;\r\n  display: flex;\r\n  flex-direction: row;\r\n  justify-content: space-between;\r\n}\r\n\r\n.poke-name {\r\n  font-size: 1.3rem;\r\n  font-weight: 400;\r\n  text-transform: capitalize;\r\n  display: flex;\r\n  align-self: self-start;\r\n}\r\n\r\n.poke-likes {\r\n  display: flex;\r\n  gap: 10px;\r\n  font-size: 1.1rem;\r\n  justify-content: right;\r\n  align-items: center;\r\n}\r\n\r\n.poke-likes i {\r\n  color: red;\r\n  transition: 0.2s ease-in-out;\r\n}\r\n\r\n.poke-likes i:hover {\r\n  cursor: pointer;\r\n  transform: scale(1.5);\r\n}\r\n\r\n.comment-button {\r\n  padding: 0.5rem;\r\n  width: 100%;\r\n  border: 2px solid transparent;\r\n  border-radius: 10px;\r\n  font-size: 18px;\r\n  font-weight: 400;\r\n  transition: 0.2s ease-in-out;\r\n  border-color: #6f23ff;\r\n  background-color: transparent;\r\n  color: #6f23ff;\r\n}\r\n\r\n.comment-button:hover {\r\n  cursor: pointer;\r\n  background: #6f23ff;\r\n  color: #fff;\r\n}\r\n\r\n/* .comments-list {\r\n  display: flex;\r\n  flex-direction: column;\r\n} */\r\n\r\n.pop-up {\r\n  position: fixed;\r\n  top: 50%;\r\n  left: 50%;\r\n  transform: translate(-50%, -50%) scale(0);\r\n  transition: 0.2s ease-in-out;\r\n  padding: 2%;\r\n  border-radius: 20px;\r\n  z-index: 20;\r\n  width: 60%;\r\n  max-width: 80%;\r\n  background: #6f23ff;\r\n  color: #fff;\r\n  max-height: 97%;\r\n  overflow-y: scroll;\r\n}\r\n\r\n#shadow {\r\n  position: fixed;\r\n  z-index: 3;\r\n  top: 0;\r\n  right: 0;\r\n  bottom: 0;\r\n  left: 0;\r\n  background-color: rgba(0, 0, 0, 0.8);\r\n  transition: 0.2s ease-in-out;\r\n  pointer-events: none;\r\n  opacity: 0;\r\n}\r\n\r\n#shadow.active {\r\n  opacity: 1;\r\n  pointer-events: all;\r\n}\r\n\r\n.pop-up.active {\r\n  transform: translate(-50%, -50%) scale(1);\r\n}\r\n\r\n.pop-top {\r\n  max-width: 10rem;\r\n  max-height: 10rem;\r\n  padding: 2rem;\r\n  background-color: #fff;\r\n  border-radius: 50%;\r\n  margin: auto;\r\n  text-align: center;\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: center;\r\n}\r\n\r\n.pop-top img {\r\n  max-width: 100%;\r\n}\r\n\r\n.close-pop {\r\n  position: absolute;\r\n  top: 20px;\r\n  right: 20px;\r\n  text-align: center;\r\n  font-size: 35px;\r\n  font-weight: 400;\r\n  color: white;\r\n  padding: 0 10px;\r\n  width: 3.5rem;\r\n  background-color: rgba(255, 0, 0, 0.836);\r\n  border: none;\r\n  border-radius: 7px;\r\n  transition: transform 0.2s ease-in-out;\r\n}\r\n\r\n.close-pop:hover {\r\n  cursor: pointer;\r\n  transform: scale(0.9);\r\n  background-color: red;\r\n}\r\n\r\n.pop-title {\r\n  text-align: center;\r\n  margin-top: 1rem;\r\n  font-weight: 400;\r\n  font-size: 1.5rem;\r\n  text-transform: capitalize;\r\n}\r\n\r\n.pop-desc {\r\n  display: flex;\r\n  justify-content: space-evenly;\r\n  margin-top: 10px;\r\n}\r\n\r\n.pop-comments {\r\n  height: 40%;\r\n}\r\n\r\n.display-comments {\r\n  text-align: center;\r\n  font-size: 15px;\r\n  font-weight: 200;\r\n  margin-top: 10px;\r\n}\r\n\r\n.comments-list {\r\n  font-size: 15px;\r\n  display: flex;\r\n  flex-direction: column;\r\n  align-items: start;\r\n  gap: 0.8rem;\r\n  padding-left: 9.5rem;\r\n  margin: 2rem 0;\r\n  width: 82%;\r\n}\r\n\r\n.add-comment {\r\n  display: flex;\r\n  flex-direction: column;\r\n  justify-content: center;\r\n  align-items: center;\r\n  gap: 20px;\r\n}\r\n\r\n.form-title {\r\n  font-size: 15px;\r\n  font-weight: 200;\r\n}\r\n\r\n.comment-input,\r\n.comment-textarea {\r\n  border: none;\r\n  padding: 5px 10px;\r\n  border-radius: 10px;\r\n  width: 60%;\r\n  height: 3rem;\r\n}\r\n\r\n.comment-textarea {\r\n  height: 7rem;\r\n}\r\n\r\n.comment-input:focus,\r\n.comment-textarea:focus {\r\n  outline: 2px solid rgba(96, 165, 250, 1.9);\r\n}\r\n\r\n.add-button {\r\n  padding: 0.5rem;\r\n  border: 2px solid #fff;\r\n  color: #fff;\r\n  border-radius: 10px;\r\n  font-size: 18px;\r\n  font-weight: 400;\r\n  transition: 0.2s ease-in-out;\r\n  width: 60%;\r\n  height: 3rem;\r\n  background-color: transparent;\r\n}\r\n\r\n.add-button:hover {\r\n  cursor: pointer;\r\n  color: #6f23ff;\r\n  background-color: #fff;\r\n}\r\n\r\n@media only screen and (max-width: 768px) {\r\n  .pop-up {\r\n    width: 80%;\r\n    max-width: 100%;\r\n    height: auto;\r\n    padding-bottom: 2%;\r\n  }\r\n\r\n  .comments-list {\r\n    grid-template-columns: 1fr;\r\n    padding: 1% 3% 1% 10%;\r\n    line-height: 0;\r\n  }\r\n\r\n  .comments-list li {\r\n    line-height: 20px;\r\n  }\r\n}\r\n\r\n@media only screen and (max-width: 768px) {\r\n  .pokemons {\r\n    display: grid;\r\n    grid-template-columns: 1fr 1fr;\r\n    padding: 2% 3%;\r\n    margin-bottom: 80px;\r\n  }\r\n}\r\n\r\n@media only screen and (max-width: 370px) {\r\n  .pokemons {\r\n    display: grid;\r\n    grid-template-columns: 1fr;\r\n    padding: 2% 3%;\r\n  }\r\n}\r\n\r\n@media only screen and (min-width: 770px) {\r\n  .pokemons {\r\n    display: grid;\r\n    grid-template-columns: 1fr 1fr 1fr;\r\n    padding: 2% 3%;\r\n  }\r\n}\r\n\r\n@media only screen and (min-width: 1090px) {\r\n  .pokemons {\r\n    display: grid;\r\n    grid-template-columns: 1fr 1fr 1fr;\r\n    padding: 2% 3%;\r\n  }\r\n}\r\n\r\n@media only screen and (min-width: 1235px) {\r\n  .pokemons {\r\n    display: grid;\r\n    grid-template-columns: 1fr 1fr 1fr 1fr;\r\n    padding: 2% 10%;\r\n  }\r\n}\r\n\r\n@media only screen and (max-width: 960px) {\r\n  .nav-item a {\r\n    font-size: 20px;\r\n  }\r\n\r\n  #poke-logo {\r\n    width: 52%;\r\n    max-width: 55%;\r\n  }\r\n}\r\n\r\n@media only screen and (max-width: 768px) {\r\n  #poke-logo {\r\n    width: 50%;\r\n    max-width: 50%;\r\n  }\r\n}\r\n\r\n@media only screen and (max-width: 496px) {\r\n  #poke-logo {\r\n    width: 80%;\r\n    max-width: 100%;\r\n  }\r\n\r\n  header {\r\n    flex-direction: column;\r\n    justify-content: center;\r\n    align-items: center;\r\n    gap: 20px;\r\n    padding: 2% 10%;\r\n  }\r\n}\r\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _modules_pokefetchfunction_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/pokefetchfunction.js */ "./src/modules/pokefetchfunction.js");
/* harmony import */ var _modules_getpokemon_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/getpokemon.js */ "./src/modules/getpokemon.js");



document.getElementById('poke-logo').textContent = 'POKEMON';
_modules_pokefetchfunction_js__WEBPACK_IMPORTED_MODULE_1__["default"].fetchPoke();
_modules_getpokemon_js__WEBPACK_IMPORTED_MODULE_2__["default"].commentFn();
})();
